...
Generated: 2026-08-09 15:55:53 UTC
...
=== Nim SPSC ring buffer, cross-process (fork), N=500000 ===
  received 500000 messages in 0.0091s  (54968238. msg/s)
```
...
=== Nim -> C++ FlatBuffers LaserScan (n=2000 points) ===
  build (from seq[float32])        mean=    0.33us  p50=    0.33us  p99=    0.34us  size=   8072B
