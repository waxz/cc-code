...
Generated: 2026-08-02 02:41:24 UTC
...
=== Nim SPSC ring buffer, cross-process (fork), N=500000 ===
  received 500000 messages in 0.0087s  (57543743. msg/s)
```
...
=== Nim -> C++ FlatBuffers IMU batch (n=1 samples/msg) ===
  build (Nim -> C++ FlatBufferBuilder) mean=    0.08us  p50=    0.08us  p99=    0.14us  size=     56B
  read+sum (zero-copy, C++ accessors) mean=    0.03us  p50=    0.03us  p99=    0.03us  size=     56B

=== Nim -> C++ FlatBuffers LaserScan (n=1080 points) ===
  build (from seq[float32])        mean=    0.30us  p50=    0.30us  p99=    0.35us  size=   4392B
  read+sum (all elements)          mean=    1.04us  p50=    1.03us  p99=    1.05us  size=   4392B

=== Nim -> C++ FlatBuffers LaserScan (n=2000 points) ===
  build (from seq[float32])        mean=    0.34us  p50=    0.33us  p99=    0.45us  size=   8072B
