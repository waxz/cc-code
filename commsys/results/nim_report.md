...
Generated: 2026-08-09 07:36:11 UTC
...
=== Nim SPSC ring buffer, cross-process (fork), N=500000 ===
  received 500000 messages in 0.0088s  (56780597. msg/s)
```
...
=== Nim -> C++ FlatBuffers IMU batch (n=20 samples/msg) ===
  build (Nim -> C++ FlatBufferBuilder) mean=    0.16us  p50=    0.15us  p99=    0.22us  size=    664B
...
=== Nim -> C++ FlatBuffers LaserScan (n=2000 points) ===
  build (from seq[float32])        mean=    0.33us  p50=    0.33us  p99=    0.36us  size=   8072B
