...
Generated: 2026-08-07 21:10:55 UTC
...
=== Nim SPSC ring buffer, cross-process (fork), N=500000 ===
  received 500000 messages in 0.0053s  (93902921. msg/s)
```
...
=== Nim -> C++ FlatBuffers IMU batch (n=20 samples/msg) ===
  build (Nim -> C++ FlatBufferBuilder) mean=    0.17us  p50=    0.17us  p99=    0.20us  size=    664B
...
=== Nim -> C++ FlatBuffers LaserScan (n=1080 points) ===
  build (from seq[float32])        mean=    0.24us  p50=    0.24us  p99=    0.28us  size=   4392B
